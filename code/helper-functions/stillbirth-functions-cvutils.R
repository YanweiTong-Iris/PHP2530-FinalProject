...
extractFits = function(test, cv_tsb, cv_vb, cv_sp1, cv_sp2, cv_pensp, rf, cv_tsb_default = NULL, adjust=F){
   ...
   # rf
   test$phat_oos_rf = rf$phat_oos / padjust * rescale
   test$phat_oos_rf_lb = test$phat_oos_rf - 1.96 * rf$phat_oos_se
   test$phat_oos_rf_ub = test$phat_oos_rf + 1.96 * rf$phat_oos_se
   test$phat_oos_rf_binll = rf$binll_oos
